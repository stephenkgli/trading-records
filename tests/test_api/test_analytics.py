...
class TestAnalyticsDaily:
    ...
    def test_daily_returns_200(self, client, db_session, seed_analytics_data):
        """Daily analytics endpoint should return 200."""
        seed_analytics_data()
        response = client.get("/api/v1/analytics/daily")
        assert response.status_code == 200

    def test_daily_with_date_range(self, client, db_session, seed_analytics_data):
    ...
    def test_daily_empty_db(self, client):
...
class TestAnalyticsCalendar:
    ...
    def test_calendar_returns_200(self, client, db_session, seed_analytics_data):
    ...
    def test_calendar_requires_params(self, client):
...
class TestAnalyticsBySymbol:
    ...
    def test_by_symbol_returns_200(self, client, db_session, seed_analytics_data):
        """By-symbol endpoint should return 200."""
        seed_analytics_data()
        response = client.get("/api/v1/analytics/by-symbol")
        assert response.status_code == 200

    def test_by_symbol_with_date_filter(self, client, db_session, seed_analytics_data):
...
class TestAnalyticsByStrategy:
    ...
    def test_by_strategy_returns_200(self, client, db_session, seed_analytics_data):
        """By-strategy endpoint should return 200."""
        seed_analytics_data()
        response = client.get("/api/v1/analytics/by-strategy")
        assert response.status_code == 200
...
class TestAnalyticsPerformance:
    ...
    def test_performance_returns_200(self, client, db_session, seed_analytics_data):
        """Performance endpoint should return 200."""
        seed_analytics_data()
        response = client.get("/api/v1/analytics/performance")
        assert response.status_code == 200

    def test_performance_returns_expected_metrics(self, client, db_session, seed_analytics_data):
    ...
    def test_performance_empty_db(self, client):
        """Performance metrics with no data should return sensible defaults."""
        response = client.get("/api/v1/analytics/performance")
        assert response.status_code == 200

    def test_performance_with_date_filter(self, client, db_session, seed_analytics_data):
